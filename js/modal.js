...
jQuery(window).load(function() {
    ...
    var popup = jQuery.cookie('popup') || 0;
    popup++;
    ...
    jQuery.cookie('popup', popup, { expires: 60000, path: '/' });
